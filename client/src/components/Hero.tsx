      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-20 w-full">
        <div className="text-center space-y-6 max-w-5xl mx-auto">
          ...
          <div className="relative flex items-center justify-center gap-8 my-12">
            <div className="hidden lg:block flex-1 text-right space-y-4">
              <p className="text-lg text-muted-foreground leading-relaxed">
                Every learner is unique. CertGenix begins with you — your strengths, gaps, and goals.
              </p>
            </div>
            ...
            <div className="hidden lg:block flex-1 text-left space-y-4">
              <p className="text-lg text-muted-foreground leading-relaxed">
          ...
          <p className="lg:hidden text-lg md:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto" data-testid="text-hero-subheadline">
